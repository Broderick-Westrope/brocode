# BroCode — an opinionated fork of OpenCode.

- See OpenCode [repo](https://github.com/anomalyco/opencode) or [website](https://opencode.ai/) for more information on the core of this project.
- See [FORK.md](./FORK.md) for a summary of fork-specific changes.
